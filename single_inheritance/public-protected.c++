...
public:
 ...
 int main() {
            // Note: In this case, Dog is protected inheriting from Animal,
            // so the members of Animal are  accessible inside Dog but not outside Dog without public and protected method (function).
        Animal animal;
        Dog dog;
         animal.age = 5; //  'age' is public  in 'Animal' so it can be accessed everywhere
        // dog.age = 5; // Error: 'age' is public in 'Animal' but Dog inherits protected, so it cannot access it directly
